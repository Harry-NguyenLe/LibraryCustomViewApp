//package vn.edu.csc.librarycustomviewapp;
//
...
//    int mTextColor = 0;
//
//    boolean mClockWise = false;
//    boolean mEnabled = false;
//
//    Drawable mIndicatiorIcon;
//
//    int mTranslateX;
//    int mTranslateY;
//    int mArcRadius;
...
//
//    //Use in view creation programmatically
...
//
//        //A structure describing general information about a display, such as its size, density, and font scaling. Using display metric method
//        float density = getResources().getDisplayMetrics().density;
//
//        //Default, may need to link this into theme settings
//        int arcColor = ContextCompat.getColor(mContext, R.color.color_arc);
//        int progressColor = ContextCompat.getColor(mContext, R.color.color_progress);
//        int textColor = ContextCompat.getColor(mContext, R.color.color_text);
//
//        mProgressWidth = (int) (mProgressWidth * density);
//        mArcWidth = (int) (mArcWidth * density);
//        mTextSize = (int) (mTextSize * density);
//
//        mIndicatiorIcon = ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_round);
//
//        if (attrs != null) {
//            //initial view
//            TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.SwagPoint);
//
//            mIndicatiorIcon = typedArray.getDrawable(R.styleable.SwagPoint_indicatorIcon);
//            if (mIndicatiorIcon != null) {
//                int indicatorIconHalfHeight = mIndicatiorIcon.getIntrinsicHeight() / 2;
//                int indicatorIconHalfWidth = mIndicatiorIcon.getIntrinsicWidth() / 2;
//            }
//            mMax = typedArray.getInt(R.styleable.SwagPoint_max, 0);
//            mMin = typedArray.getInt(R.styleable.SwagPoint_min, 0);
//            mStep = typedArray.getInt(R.styleable.SwagPoint_step, 0);
//
//            mProgressWidth = (int) typedArray.getDimension(R.styleable.SwagPoint_progressWidth, 0);
//            mArcWidth = (int) typedArray.getDimension(R.styleable.SwagPoint_arcWidth, 0);
//            mTextSize = (int) typedArray.getDimension(R.styleable.SwagPoint_textSize, 0);
//
//            mProgressColor = typedArray.getColor(R.styleable.SwagPoint_progressColor, 0);
//            mArcColor = typedArray.getColor(R.styleable.SwagPoint_arcColor, 0);
//            mTextColor = typedArray.getColor(R.styleable.SwagPoint_textColor, 0);
//
//            mClockWise = typedArray.getBoolean(R.styleable.SwagPoint_clockWise, false);
//            mEnabled = typedArray.getBoolean(R.styleable.SwagPoint_enabled, false);
//
//            typedArray.recycle();
//        }
//
//    }
//
//    //to control the view's dimension we have to override this callback method
//    @Override
...
//    }
//}
package vn.edu.csc.librarycustomviewapp.Utilities;
...
public class SwagPoints extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mIndicatorIcon = ContextCompat.getDrawable(context, R.mipmap.ic_launcher_round);
